...
Broadcast and Presence for your channels based on the operations set in your policies: * `SELECT` policies:
Able to receive messages from the channel * `INSERT` policies: Able to send messages to the channel

This approach to control access should be familiar to users of [Supabase Storage](/docs/guides/storage/security/access-control).
